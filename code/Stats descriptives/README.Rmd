...
### Visualisation du lien entre structure_boucle et les Labels
...
On constate que quasiment tous les labels sont assez fortement corrélés, et même dans le même sens. Cela indique qu'une augmentation d'une dégradation est certainement en lien avec l'augmentation des autres.
...
Les p_values étant toutes extrêment faibles (même, ici = 0), on réfute l'hypothèse H0 du test de correlation qui est une supposition de la non-correlation des variables.
