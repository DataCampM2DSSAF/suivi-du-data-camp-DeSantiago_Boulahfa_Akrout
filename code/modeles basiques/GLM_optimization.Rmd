...
formula_gamma_deg_pH10 =
  "deg_pH10  ~ sequence + seq_be + seq_af + index_sequence + structure"
```
...
formula_inverse_gaussian_deg_pH10 =
  "deg_pH10  ~ sequence + seq_be + struct_af + index_sequence + structure"
```
...
formula_gamma_deg_Mg_50C =
  "deg_Mg_50C  ~ sequence + seq_be + seq_af + index_sequence + structure"
```
...
formula_inverse_gaussian_deg_Mg_50C =
  "deg_Mg_50C  ~ sequence + seq_be + struct_af + index_sequence + structure"
```
...
formula_gamma_deg_50C =
  "deg_50C  ~ sequence + seq_be + seq_af + index_sequence + structure"
```
...
formula_inverse_gaussian_deg_50C =
  "deg_50C  ~ sequence + seq_be + struct_af + index_sequence + structure"
```
